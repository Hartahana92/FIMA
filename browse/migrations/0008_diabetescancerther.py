# Generated by Django 4.0.2 on 2022-08-18 04:35
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('browse', '0007_colorectalcancermet_colorectalcancerpaper'),
    ]

    operations = [
        migrations.CreateModel(
            name='DiabetesCancerTher',
            fields=[
                ...
                ('hmdb_id', models.TextField(blank=True, db_column='HMDB ID', primary_key=True, serialize=False)),
