# Generated by Django 4.0.2 on 2022-08-18 15:03
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('browse', '0011_colorectalcancerther'),
    ]

    operations = [
        migrations.CreateModel(
            name='ArthritisCancerTher',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fold_change_n_case_control_field', models.TextField(blank=True, db_column='fold change n(case/ control)', null=True)),
                ('change_direction', models.TextField(blank=True, db_column='Change direction', null=True)),
                ('raw_p_value', models.DecimalField(blank=True, db_column='RAW p-value', decimal_places=65535, max_digits=65535, null=True)),
                ('fdr', models.TextField(blank=True, null=True)),
                ('vip', models.TextField(blank=True, null=True)),
                ('classification_method', models.TextField(blank=True, db_column='Classification method', null=True)),
                ('cutoff_value', models.TextField(blank=True, db_column='Cutoff value', null=True)),
